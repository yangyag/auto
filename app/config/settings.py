...
ACTIVE_WINDOW_ABOVE_CURRENT_REENTRY_SLOTS = 8
...
# ── 손절 (Stop Loss) ───────────────────────────────────────
STOP_LOSS_MODE = os.getenv("STOP_LOSS_MODE", "band_multiple")
STOP_LOSS_BAND_MULTIPLE = Decimal(os.getenv("STOP_LOSS_BAND_MULTIPLE", "1.5"))
STOP_LOSS_L0_PCT = Decimal(os.getenv("STOP_LOSS_L0_PCT", "10"))
STOP_LOSS_L1_PCT = Decimal(os.getenv("STOP_LOSS_L1_PCT", "20"))
STOP_LOSS_L2_PCT = Decimal(os.getenv("STOP_LOSS_L2_PCT", "30"))
STOP_LOSS_CANDLE_UNIT = int(os.getenv("STOP_LOSS_CANDLE_UNIT", "15"))
STOP_LOSS_L0_CONSECUTIVE_CLOSES = int(os.getenv("STOP_LOSS_L0_CONSECUTIVE_CLOSES", "4"))
STOP_LOSS_L1_CONSECUTIVE_CLOSES = int(os.getenv("STOP_LOSS_L1_CONSECUTIVE_CLOSES", "4"))
STOP_LOSS_L2_CONSECUTIVE_CLOSES = int(os.getenv("STOP_LOSS_L2_CONSECUTIVE_CLOSES", "2"))
STOP_LOSS_L1_ARM_HOLD_SECONDS = int(os.getenv("STOP_LOSS_L1_ARM_HOLD_SECONDS", "3600"))
STOP_LOSS_L2_ARM_HOLD_SECONDS = int(os.getenv("STOP_LOSS_L2_ARM_HOLD_SECONDS", "1800"))
STOP_LOSS_L1_LIQUIDATE_RATIO = Decimal(os.getenv("STOP_LOSS_L1_LIQUIDATE_RATIO", "0.5"))
STOP_LOSS_RESTART_LOCKOUT_HOURS = int(os.getenv("STOP_LOSS_RESTART_LOCKOUT_HOURS", "24"))
STOP_LOSS_WEBHOOK_URL = os.getenv("STOP_LOSS_WEBHOOK_URL", "")
STOP_LOSS_NOTIFICATION_ENABLED = _env_bool("STOP_LOSS_NOTIFICATION_ENABLED", True)
